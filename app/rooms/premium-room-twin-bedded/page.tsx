...
export default function RoomPage() {
  return (
    <main className="min-h-screen">
      ...
      <RoomDetails
        breadcrumbs={[{ label: "Hotel Eden", href: "/" }, { label: "Rooms", href: "/rooms" }, { label: "Premium Room (Twin Bedded)" }]}
        title="Premium Room (Twin Bedded)"
        description={[
          "A comfortable private room with twin beds, modern interiors, and all essential amenities for a peaceful stay. Ideal for friends or colleagues sharing a room.",
          "Enjoy the flexibility of separate beds without compromising on comfort or style.",
        ]}
        details={{
          view: "City View",
          size: "240 sq. ft.",
