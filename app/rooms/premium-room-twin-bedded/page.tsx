...
export default function RoomPage() {
  return (
    <main className="min-h-screen">
      <Hero title="Premium Room (Twin Bedded)" description="A comfortable private room with twin beds, modern interiors, and all essential amenities for a peaceful stay."  />
