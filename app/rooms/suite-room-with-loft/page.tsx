...
export default function RoomPage() {
  return (
    <main className="min-h-screen">
      ...
      <RoomDetails
        breadcrumbs={[{ label: "Hotel Eden", href: "/" }, { label: "Rooms", href: "/rooms" }, { label: "Suite Room With Loft" }]}
        title="Suite Room With Loft"
        description={[
          "A stylish suite featuring a loft area, offering extra space and a unique, airy atmosphere for guests. This creatively designed room combines modern aesthetics with practical luxury.",
          "The loft design adds a sense of openness, making it a perfect choice for families or groups who appreciate style and space.",
        ]}
        details={{
          view: "City View",
          size: "380 sq. ft.",
          occupancy: "2 Adults, 2 Children",
          bedding: "1 King Bed + Loft Bed",
        }}
        amenities={[
          { icon: <FaSnowflake />, label: "Air-Conditioning" },
          { icon: <FaBath />, label: "Ensuite Bathroom" },
          { icon: <FaPlug />, label: "Power Backup" },
        ]}
        extraAmenitiesCount={3}
      />

      <GalleryOne galleryImages={galleryImages} title="Gallery" description="Explore our Suite Room With Loft." cta="" />
