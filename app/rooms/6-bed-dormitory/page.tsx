...
export default function RoomPage() {
  return (
    <main className="min-h-screen">
      <Hero title="6-Bed Dormitory" description="A cozy, group-friendly dormitory offering essential comforts for a relaxed and convenient stay." />

      <RoomDetails
        breadcrumbs={[{ label: "Hotel Eden", href: "/" }, { label: "Rooms", href: "/rooms" }, { label: "6-Bed Dormitory" }]}
        title="6-Bed Dormitory"
        description={[
          "A cozy, group-friendly dormitory offering essential comforts for a relaxed and convenient stay. Perfect for solo travelers or groups of friends looking for an affordable yet comfortable option.",
          "Enjoy clean linens, personal storage space, and a vibrant community atmosphere.",
        ]}
        details={{
          view: "Community View",
          size: "300 sq. ft.",
        ...
        amenities={[
          ...
          { icon: <FaBath />, label: "Shared Bathroom" }, // Adapted for Dorm
      ...
      <TestimonialSection title="What Our Guests Love About Us" subtitle="From authentic guest experiences and cherished memories, discover why Hotel Eden is the perfect choice for your stay." reviews={testimonialData} />
