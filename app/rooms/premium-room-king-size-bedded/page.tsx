...
export default function RoomPage() {
  return (
    <main className="min-h-screen">
      ...
      <RoomDetails
        breadcrumbs={[{ label: "Hotel Eden", href: "/" }, { label: "Rooms", href: "/rooms" }, { label: "Premium Room (King Size Bedded)" }]}
        title="Premium Room (King Size Bedded)"
        description={[
          "A stylish and comfortable room with a king-size bed, designed for guests who prefer extra space and a relaxed stay. Modern decor and thoughtful details create a welcoming atmosphere.",
          "Relax in the comfort of a large bed and enjoy premium amenities after a day of exploration.",
        ]}
        details={{
          view: "City View",
          size: "240 sq. ft.",
      ...
      <GalleryOne galleryImages={galleryImages} title="Gallery" description="Explore our Premium Room." cta="" />
