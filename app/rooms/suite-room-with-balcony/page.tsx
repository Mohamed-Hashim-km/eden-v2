...
export default function RoomPage() {
  return (
    <main className="min-h-screen">
      ...
      <RoomDetails
        breadcrumbs={[{ label: "Hotel Eden", href: "/" }, { label: "Rooms", href: "/rooms" }, { label: "Suite Room (With Balcony)" }]}
        title="Suite Room (With Balcony)"
        description={[
          "A spacious and refined suite with a private balcony, perfect for guests who enjoy open views and an elevated stay experience. Start your day with fresh air and end it with a peaceful evening under the stars.",
          "Inside, finding comfort is effortless with plush bedding, premium amenities, and a layout designed for relaxation.",
        ]}
        details={{
      ...
      <GalleryOne galleryImages={galleryImages} title="Gallery" description="Explore our Suite Room (With Balcony)." cta="" />
