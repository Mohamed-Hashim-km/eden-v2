...
export default function RoomPage() {
  return (
    <main className="min-h-screen">
      ...
      <RoomDetails
        breadcrumbs={[{ label: "Hotel Eden", href: "/" }, { label: "Rooms", href: "/rooms" }, { label: "Club Room" }]}
        title="Club Room"
        description={[
          "Spacious and refined, offering added comfort and thoughtful conveniences. The Club Room at Eden Ember Castle provides an elevated stay experience with more space and premium touches.",
          "Ideal for couples or small families, this room features enhanced amenities and a relaxing ambiance to ensure a memorable stay in Gokarna.",
        ]}
        details={{
      ...
      <GalleryOne galleryImages={galleryImages} title="Gallery" description="Explore the Club Room." cta="" />
