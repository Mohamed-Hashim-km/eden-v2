...
export default function RoomPage() {
  return (
    <main className="min-h-screen">
      ...
      <RoomDetails
        breadcrumbs={[{ label: "Hotel Eden", href: "/" }, { label: "Rooms", href: "/rooms" }, { label: "Suite Room" }]}
        title="Suite Room"
        description={[
          "An expansive suite with sophisticated decor and thoughtful amenities, designed for comfort and relaxation. Experience the epitome of luxury with our distinctively designed Suite Room.",
          "Featuring separate living and sleeping areas, this suite provides the perfect sanctuary for guests seeking extra space and privacy.",
        ]}
        details={{
      ...
      <GalleryOne galleryImages={galleryImages} title="Gallery" description="Explore our Suite Room." cta="" />
