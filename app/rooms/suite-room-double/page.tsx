...
export default function RoomPage() {
  return (
    <main className="min-h-screen">
      ...
      <RoomDetails
        breadcrumbs={[{ label: "Hotel Eden", href: "/" }, { label: "Rooms", href: "/rooms" }, { label: "Suite Double Room" }]}
        title="Suite Double Room"
        description={[
          "The Suite Double Room features a spacious, elegantly designed interior with a comfortable double bed, modern amenities, and a relaxing atmosphere. Created with couples in mind, this room offers a romantic and serene setting.",
          "Enjoy distinct luxury and personalized comfort in every corner of this beautifully appointed room.",
        ]}
        details={{
          view: "City View",
          size: "300 sq. ft.",
