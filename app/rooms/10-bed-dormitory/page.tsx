...
export default function RoomPage() {
  return (
    <main className="min-h-screen">
      ...
      <RoomDetails
        breadcrumbs={[{ label: "Hotel Eden", href: "/" }, { label: "Rooms", href: "/rooms" }, { label: "10-Bed Dormitory" }]}
        title="10-Bed Dormitory"
        description={[
          ...
          "Ideal for large groups or solo travelers seeking a budget-friendly yet premium hostel experience.",
        ]}
        details={{
          view: "Community View",
          size: "450 sq. ft.",
        ...
        amenities={[
          ...
          { icon: <FaBath />, label: "Shared Bathroom" },
