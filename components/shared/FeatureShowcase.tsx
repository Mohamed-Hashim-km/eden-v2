    ...
    <section className="py-12 md:py-24 bg-white overflow-hidden">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="flex flex-col md:flex-row items-start relative">
          ...
          */}
          <div className="w-full md:w-[55%] z-10 relative md:-mr-32 mb-8 md:mb-0">
            <div className="bg-[#001446] p-8 md:p-12 lg:p-16 lg:pr-32 shadow-2xl w-full text-left">
              
              <h2 className="text-3xl md:text-4xl lg:text-5xl text-[#F7F4ED] font-serif mb-6 leading-tight">
                {title}
              </h2>
              ...
              */}
              <p className="text-[#F7F4ED] leading-relaxed mb-10 text-base lg:text-lg font-light opacity-90 lg:pr-12">
                {description}
              </p>
