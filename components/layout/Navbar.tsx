  ...
  return (
    ...
    <header className="w-full bg-[#001446] md:bg-transparent  md:hover:bg-[#001446] transition-colors duration-300 text-[#FAF5EB] flex flex-col items-center absolute z-50">
      ...
      <div className="hidden md:flex flex-col w-full items-center">
        ...
        <nav className="w-full flex justify-center relative z-50">
          <div className="flex items-center gap-32 text-lg ">
            ...
            <div className="relative group cursor-pointer py-5">
              ...
              <div className="absolute top-full left-0 pt-0 w-80 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform origin-top">
            ...
            <div className="group cursor-pointer py-5">
              ...
              <div className="absolute top-full left-1/2 -translate-x-1/2 pt-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform origin-top z-50">
                <DiningDropdown />
              </div>
            </div>

            <Link href="/spa" className="hover:opacity-80 transition-opacity py-5">
              Spa
            </Link>
            <Link href="/contact" className="hover:opacity-80 transition-opacity py-5">
              Contact
            </Link>
          </div>
        </nav>
