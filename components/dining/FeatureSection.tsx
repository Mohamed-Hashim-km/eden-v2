          ...
          */}
          ...
          <div className="w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-0 items-center">
            ...
            */}
            ...
            {/* Content Section */}
            <div className="lg:col-span-5 bg-[#E5CAA4] lg:bg-transparent p-8 md:p-12 lg:pl-16 lg:pr-12 xl:pl-24">
              <div className="max-w-xl">
                <h2 className="text-3xl md:text-4xl text-[#001446] mb-6">Explore Our Flavours</h2>
